...
background = pygame.image.load(path.join(img_dir, "CatYellow.png")).convert()
background_rect = background.get_rect()
player_img = pygame.image.load(path.join(img_dir, "CatPlayer.png")).convert()
bullet_img = pygame.image.load(path.join(img_dir, "cat_paw.png")).convert()
meteor_images = []
meteor_list = ['trash_big1.png', 'trash_big2.png', 'trash_big3.png',
               'trash_small1.png', 'trash_small2.png', 'trash_small3.png']
